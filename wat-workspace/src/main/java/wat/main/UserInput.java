...
public class UserInput {
    ...
    public static int getMenuSelection() {
        ...
        log.info("* 14-) exit                                    *");
        log.info("************************************************");
        return UserInput.getSelectionBetween(1, 10);
    }
    ...
    public static int getListingOptions() {
        log.info("***********************************************");
        log.info("* 1 to listSenseKeyAndSynsetsOfAdjectives     *");
        log.info("* 2 to listNounsWithPointers                  *");
        log.info("* 3 to listVerbs                              *");
        log.info("* 4 to cancel                                 *");
        log.info("***********************************************");
        return UserInput.getSelectionBetween(1, 4);
    }
